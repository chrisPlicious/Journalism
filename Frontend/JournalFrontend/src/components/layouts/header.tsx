...
export default function Header({ onSidebarToggle }: HeaderProps) {
  ...
  return (
    <header className="h-16 bg-[var(--background)]/85 backdrop-blur-lg border-b border-[var(--border)]/60 flex items-center justify-between px-4 sticky top-0 z-50">
      {/* Left: Sidebar toggle */}
      <div className="flex items-center gap-2 md:gap-7">
        ...
        <h1 className="hidden md:block font-serif text-xl font-semibold text-[var(--sage-700)]">
          MindNest
        </h1>
      </div>
      ...
      >
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-10 w-full rounded-full bg-[var(--input)] border-transparent focus:ring-[var(--sage-400)] focus:border-[var(--sage-400)] text-[var(--foreground)] placeholder-[var(--muted-foreground)]"
          />
          ...
          <Button
            ...
            className="absolute right-1 top-1/2 transform -translate-y-1/2 min-h-[44px] min-w-[44px] p-0 hover:bg-transparent"
            aria-label="Clear search"
          >
            <RotateCcw className="h-4 w-4 text-[var(--muted-foreground)] hover:text-[var(--foreground)]" />
          </Button>
        </div>
      </form>
      ...
      <div className="flex items-center gap-1 md:gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className="flex items-center gap-2 px-2 rounded-lg hover:bg-[var(--muted)] min-h-[44px]"
